...
public abstract class FlowButton : TemplatedControl
{
    ...
    public static readonly StyledProperty<ICommand?> CommandProperty =
        AvaloniaProperty.Register<FlowButton, ICommand?>(nameof(Command));
    ...
    public static readonly StyledProperty<object?> CommandParameterProperty =
        AvaloniaProperty.Register<FlowButton, object?>(nameof(CommandParameter));
    ...
    static FlowButton()
    {
        ...
        CommandProperty.Changed.AddClassHandler<FlowButton, ICommand?>((sender, e) =>
        {
    ...
    public static readonly RoutedEvent<RoutedEventArgs> ClickEvent =
        RoutedEvent.Register<FlowButton, RoutedEventArgs>(nameof(Click), RoutingStrategies.Bubble);
